                ...
                >
                    ...
                    >
                        ...
                        >
                            <button
                                @click="closeModal"
                                class="absolute top-4 right-4 z-10 flex h-8 w-8 items-center justify-center rounded-full bg-slate-100 text-slate-500 transition-colors hover:bg-rose-500 hover:text-white"
                            >
                            ...
                            <div class="p-6 sm:p-8" v-if="selectedItem">
                                ...
                                <button
                                    @click="closeModal"
                                    class="w-full rounded-xl bg-gradient-to-r from-blue-700 to-blue-600 px-4 py-3.5 font-bold text-white shadow-md transition-all hover:from-blue-800 hover:to-blue-700"
                                >
                                    Tutup
                                </button>
                            </div>
