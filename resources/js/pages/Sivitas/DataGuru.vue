    ...
    <AppLayout>
        <section class="min-h-screen bg-gray-50 py-8 sm:py-12">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div
                    v-if="displayedTeachers.data.length === 0"
                ...
                >
                    ...
                    <p class="mt-2 text-sm text-gray-500">
                        Belum ada data guru yang sesuai dengan pencarian Anda.
                    </p>
                </div>
                ...
                >
                    <article
                        v-for="item in displayedTeachers.data"
                        :key="item.id"
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <img
                                    :src="`https://ui-avatars.com/api/?name=${item.name.replace(/ /g, '+')}&background=eff6ff&color=2563eb&size=128&bold=true`"
                                    :alt="item.name"
                            ...
                            <p
                                class="mt-0.5 text-center text-xs font-semibold tracking-wider text-blue-600"
                            >
                            ...
                            <div class="mt-3">
                                <span
                                    class="inline-flex items-center rounded-full bg-gray-50 px-2.5 py-1 text-[10px] font-bold tracking-wider text-gray-600 uppercase ring-1 ring-gray-200 ring-inset"
                                >
                                    {{
                                        item.role === 'teacher'
                                            ? 'Guru Pendik'
                            ...
                            <div class="w-full space-y-2.5">
                                ...
                                <div
                                    v-if="item.classroom_id"
                                    class="flex items-center gap-2.5 text-sm font-medium text-blue-700"
                                >
                                    <svg
                ...
                <div
                    v-if="
                        displayedTeachers.links &&
                        displayedTeachers.links.length > 3
                    "
                ...
                >
                    ...
                    >
                        <template
                            v-for="(link, index) in displayedTeachers.links"
                            :key="index"
                        >
                            <div
                                v-if="link.url === null"
...
// Data Dummy Fallback sesuai Fillable Model People
const dummyData = {
    data: [
        {
            id: 1,
            name: 'Ahmad Budi Santoso, S.Pd., M.Kom.',
            email: 'ahmad.budi@sekolahku.sch.id',
            phone: '0812-3456-7890',
            id_number: '198506152010011012',
            role: 'teacher',
            classroom_id: 1,
            classroom: { name: 'XII RPL 1' }, // Simulasi data relasi tabel
        },
        {
            id: 2,
            name: 'Siti Aminah, M.Pd.',
            email: 'siti.aminah@sekolahku.sch.id',
            phone: '0857-9876-5432',
            id_number: '199008222015042008',
            role: 'teacher',
            classroom_id: null,
        },
        {
            id: 3,
            name: 'Drs. Supriyanto',
            email: 'supriyanto@sekolahku.sch.id',
            phone: '0813-1122-3344',
            id_number: '197503121998021001',
            role: 'teacher',
            classroom_id: 3,
        ...
        },
        {
            ...
            email: 'rina.wija@sekolahku.sch.id',
            phone: '-',
            id_number: '199511052020122015',
            role: 'teacher',
            classroom_id: null,
        },
        {
            id: 5,
            name: 'Bagus Prakoso, S.Kom.',
            email: 'bagus.p@sekolahku.sch.id',
            phone: '0896-5544-3322',
            id_number: '199201012018011005',
            role: 'teacher',
            classroom_id: 5,
            classroom: { name: 'X DKV 1' },
        },
    ],
    links: [
        { url: null, label: '&laquo; Previous', active: false },
        { url: '/sivitas/data-guru?page=1', label: '1', active: true },
        { url: '/sivitas/data-guru?page=2', label: '2', active: false },
        {
            url: '/sivitas/data-guru?page=2',
            label: 'Next &raquo;',
            active: false,
        },
    ],
...
// Menggunakan data dari controller jika ada, atau fallback dummy
const displayedTeachers = computed(() => {
    return props.teachers?.data?.length > 0 ? props.teachers : dummyData;
});
